...
class StudentsExpandableDataTable extends StatefulWidget {
  const StudentsExpandableDataTable(
      {super.key,
  ...
  @override
  State<StudentsExpandableDataTable> createState() =>
      _StudentsExpandableDataTableState();
}

class _StudentsExpandableDataTableState
    extends State<StudentsExpandableDataTable> {
  @override
